...
public class ValoracionesController {
    ...
    public String crearValoracion(Model model ,@RequestParam String texto,@RequestParam String puntuacion,  HttpServletRequest request){
       
        int puntos = Integer.parseInt(puntuacion);
        Usuario user = usuarioRepository.getByNombre(request.getUserPrincipal().getName()); 
